 ...
 */
public class RectPipeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.RectPipeDocument
{
    
    public RectPipeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName RECTPIPE$0 = 
    ...
    public org.landxml.schema.landXML11.RectPipeDocument.RectPipe getRectPipe()
    {
        synchronized (monitor())
        {
            ...
            target = (org.landxml.schema.landXML11.RectPipeDocument.RectPipe)get_store().find_element_user(RECTPIPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setRectPipe(org.landxml.schema.landXML11.RectPipeDocument.RectPipe rectPipe)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.RectPipeDocument.RectPipe)get_store().add_element_user(RECTPIPE$0);
            }
            target.set(rectPipe);
        }
    }
     ...
     * This is a complex type.
     */
    public static class RectPipeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.RectPipeDocument.RectPipe
    {
        
        public RectPipeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return RectPipeImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = RectPipeImpl.this.getFeatureArray(i);
                    RectPipeImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { RectPipeImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = RectPipeImpl.this.getFeatureArray(i);
                    RectPipeImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return RectPipeImpl.this.sizeOfFeatureArray(); }
