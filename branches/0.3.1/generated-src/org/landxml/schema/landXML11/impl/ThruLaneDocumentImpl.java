 ...
 */
public class ThruLaneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.ThruLaneDocument
{
    
    public ThruLaneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.landxml.schema.landXML11.ThruLaneDocument.ThruLane getThruLane()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.ThruLaneDocument.ThruLane target = null;
            target = (org.landxml.schema.landXML11.ThruLaneDocument.ThruLane)get_store().find_element_user(THRULANE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setThruLane(org.landxml.schema.landXML11.ThruLaneDocument.ThruLane thruLane)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ThruLaneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.ThruLaneDocument.ThruLane
    {
        
        public ThruLaneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return ThruLaneImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = ThruLaneImpl.this.getFeatureArray(i);
                    ThruLaneImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { ThruLaneImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = ThruLaneImpl.this.getFeatureArray(i);
                    ThruLaneImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return ThruLaneImpl.this.sizeOfFeatureArray(); }
