 ...
 */
public class CornerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.CornerDocument
{
    
    public CornerDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CORNER$0 = 
     ...
     */
    public org.landxml.schema.landXML11.CornerDocument.Corner getCorner()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.CornerDocument.Corner target = null;
            target = (org.landxml.schema.landXML11.CornerDocument.Corner)get_store().find_element_user(CORNER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCorner(org.landxml.schema.landXML11.CornerDocument.Corner corner)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.CornerDocument.Corner)get_store().add_element_user(CORNER$0);
            }
            target.set(corner);
        }
    }
     ...
     * This is a complex type.
     */
    public static class CornerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.CornerDocument.Corner
    {
        
        public CornerImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return CornerImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = CornerImpl.this.getFeatureArray(i);
                    CornerImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { CornerImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = CornerImpl.this.getFeatureArray(i);
                    CornerImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return CornerImpl.this.sizeOfFeatureArray(); }
         ...
         */
        public org.landxml.schema.landXML11.CornerType.Enum getType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                return (org.landxml.schema.landXML11.CornerType.Enum)target.getEnumValue();
            }
        }
         ...
         */
        public org.landxml.schema.landXML11.CornerType xgetType()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.landxml.schema.landXML11.CornerType target = null;
                target = (org.landxml.schema.landXML11.CornerType)get_store().find_attribute_user(TYPE$6);
                return target;
            }
        }
         ...
         */
        public void setType(org.landxml.schema.landXML11.CornerType.Enum type)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void xsetType(org.landxml.schema.landXML11.CornerType type)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.CornerType)get_store().add_attribute_user(TYPE$6);
                }
                target.set(type);
            }
        }
