 ...
 */
public class EggPipeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.EggPipeDocument
{
    
    public EggPipeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName EGGPIPE$0 = 
    ...
    public org.landxml.schema.landXML11.EggPipeDocument.EggPipe getEggPipe()
    {
        synchronized (monitor())
        {
            ...
            target = (org.landxml.schema.landXML11.EggPipeDocument.EggPipe)get_store().find_element_user(EGGPIPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setEggPipe(org.landxml.schema.landXML11.EggPipeDocument.EggPipe eggPipe)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.EggPipeDocument.EggPipe)get_store().add_element_user(EGGPIPE$0);
            }
            target.set(eggPipe);
        }
    }
     ...
     * This is a complex type.
     */
    public static class EggPipeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.EggPipeDocument.EggPipe
    {
        
        public EggPipeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return EggPipeImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = EggPipeImpl.this.getFeatureArray(i);
                    EggPipeImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { EggPipeImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = EggPipeImpl.this.getFeatureArray(i);
                    EggPipeImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return EggPipeImpl.this.sizeOfFeatureArray(); }
