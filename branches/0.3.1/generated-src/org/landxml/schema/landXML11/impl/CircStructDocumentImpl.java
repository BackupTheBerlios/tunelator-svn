 ...
 */
public class CircStructDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.CircStructDocument
{
    
    public CircStructDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CIRCSTRUCT$0 = 
    ...
    public org.landxml.schema.landXML11.CircStructDocument.CircStruct getCircStruct()
    {
        synchronized (monitor())
        {
            ...
            target = (org.landxml.schema.landXML11.CircStructDocument.CircStruct)get_store().find_element_user(CIRCSTRUCT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCircStruct(org.landxml.schema.landXML11.CircStructDocument.CircStruct circStruct)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.CircStructDocument.CircStruct)get_store().add_element_user(CIRCSTRUCT$0);
            }
     ...
     * This is a complex type.
     */
    public static class CircStructImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.CircStructDocument.CircStruct
    {
        
        public CircStructImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName INLETCASE$6 = 
            new javax.xml.namespace.QName("", "inletCase");
        private static final javax.xml.namespace.QName LOSSCOEFF$8 = 
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return CircStructImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = CircStructImpl.this.getFeatureArray(i);
                    CircStructImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { CircStructImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = CircStructImpl.this.getFeatureArray(i);
                    CircStructImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return CircStructImpl.this.sizeOfFeatureArray(); }
        ...
        public org.apache.xmlbeans.XmlAnySimpleType getInletCase()
        {
            synchronized (monitor())
            {
                ...
                target = (org.apache.xmlbeans.XmlAnySimpleType)get_store().find_attribute_user(INLETCASE$6);
                if (target == null)
                {
                    return null;
                }
        ...
        public boolean isSetInletCase()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(INLETCASE$6) != null;
            }
        }
        ...
        public void setInletCase(org.apache.xmlbeans.XmlAnySimpleType inletCase)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlAnySimpleType)get_store().add_attribute_user(INLETCASE$6);
                }
        ...
        public void unsetInletCase()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(INLETCASE$6);
            }
        }
        ...
        public double getLossCoeff()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(LOSSCOEFF$8);
                if (target == null)
                {
                    return 0.0;
                }
        ...
        public org.apache.xmlbeans.XmlDouble xgetLossCoeff()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlDouble target = null;
                target = (org.apache.xmlbeans.XmlDouble)get_store().find_attribute_user(LOSSCOEFF$8);
                return target;
            }
        }
        ...
        public boolean isSetLossCoeff()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(LOSSCOEFF$8) != null;
            }
        }
        ...
        public void setLossCoeff(double lossCoeff)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(LOSSCOEFF$8);
                }
        ...
        public void xsetLossCoeff(org.apache.xmlbeans.XmlDouble lossCoeff)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlDouble)get_store().add_attribute_user(LOSSCOEFF$8);
                }
        ...
        public void unsetLossCoeff()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(LOSSCOEFF$8);
            }
        }
