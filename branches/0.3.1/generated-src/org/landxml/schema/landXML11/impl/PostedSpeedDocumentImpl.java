 ...
 */
public class PostedSpeedDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.PostedSpeedDocument
{
    
    public PostedSpeedDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName POSTEDSPEED$0 = 
     ...
     */
    public org.landxml.schema.landXML11.PostedSpeedDocument.PostedSpeed getPostedSpeed()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.PostedSpeedDocument.PostedSpeed target = null;
            target = (org.landxml.schema.landXML11.PostedSpeedDocument.PostedSpeed)get_store().find_element_user(POSTEDSPEED$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setPostedSpeed(org.landxml.schema.landXML11.PostedSpeedDocument.PostedSpeed postedSpeed)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.PostedSpeedDocument.PostedSpeed)get_store().add_element_user(POSTEDSPEED$0);
            }
     ...
     * This is a complex type.
     */
    public static class PostedSpeedImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.PostedSpeedDocument.PostedSpeed
    {
        
        public PostedSpeedImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName SPEEDLIMIT$8 = 
            new javax.xml.namespace.QName("", "speedLimit");
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return PostedSpeedImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = PostedSpeedImpl.this.getFeatureArray(i);
                    PostedSpeedImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { PostedSpeedImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = PostedSpeedImpl.this.getFeatureArray(i);
                    PostedSpeedImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return PostedSpeedImpl.this.sizeOfFeatureArray(); }
        ...
        public double getSpeedLimit()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SPEEDLIMIT$8);
                if (target == null)
                {
                    return 0.0;
                }
         ...
         */
        public org.landxml.schema.landXML11.Speed xgetSpeedLimit()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.landxml.schema.landXML11.Speed target = null;
                target = (org.landxml.schema.landXML11.Speed)get_store().find_attribute_user(SPEEDLIMIT$8);
                return target;
            }
        }
        ...
        public boolean isSetSpeedLimit()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(SPEEDLIMIT$8) != null;
            }
        }
        ...
        public void setSpeedLimit(double speedLimit)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SPEEDLIMIT$8);
                }
                target.setDoubleValue(speedLimit);
            }
        }
         ...
         */
        public void xsetSpeedLimit(org.landxml.schema.landXML11.Speed speedLimit)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.Speed)get_store().add_attribute_user(SPEEDLIMIT$8);
                }
                target.set(speedLimit);
            }
        }
        ...
        public void unsetSpeedLimit()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(SPEEDLIMIT$8);
            }
        }
    }
}
