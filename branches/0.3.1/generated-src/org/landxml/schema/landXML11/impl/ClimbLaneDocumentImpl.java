 ...
 */
public class ClimbLaneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.ClimbLaneDocument
{
    
    public ClimbLaneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CLIMBLANE$0 = 
     ...
     */
    public org.landxml.schema.landXML11.ClimbLaneDocument.ClimbLane getClimbLane()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.ClimbLaneDocument.ClimbLane target = null;
            target = (org.landxml.schema.landXML11.ClimbLaneDocument.ClimbLane)get_store().find_element_user(CLIMBLANE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setClimbLane(org.landxml.schema.landXML11.ClimbLaneDocument.ClimbLane climbLane)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.ClimbLaneDocument.ClimbLane)get_store().add_element_user(CLIMBLANE$0);
            }
     ...
     * This is a complex type.
     */
    public static class ClimbLaneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.ClimbLaneDocument.ClimbLane
    {
        
        public ClimbLaneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return ClimbLaneImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = ClimbLaneImpl.this.getFeatureArray(i);
                    ClimbLaneImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { ClimbLaneImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = ClimbLaneImpl.this.getFeatureArray(i);
                    ClimbLaneImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return ClimbLaneImpl.this.sizeOfFeatureArray(); }
