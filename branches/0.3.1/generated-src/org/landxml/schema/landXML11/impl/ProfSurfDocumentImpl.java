 ...
 */
public class ProfSurfDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.ProfSurfDocument
{
    
    public ProfSurfDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.landxml.schema.landXML11.ProfSurfDocument.ProfSurf getProfSurf()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.ProfSurfDocument.ProfSurf target = null;
            target = (org.landxml.schema.landXML11.ProfSurfDocument.ProfSurf)get_store().find_element_user(PROFSURF$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setProfSurf(org.landxml.schema.landXML11.ProfSurfDocument.ProfSurf profSurf)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ProfSurfImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.ProfSurfDocument.ProfSurf
    {
        
        public ProfSurfImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<java.util.List> getPntList2DList()
        {
            final class PntList2DList extends java.util.AbstractList<java.util.List>
            {
                public java.util.List get(int i)
                    { return ProfSurfImpl.this.getPntList2DArray(i); }
                
                public java.util.List set(int i, java.util.List o)
                {
                    java.util.List old = ProfSurfImpl.this.getPntList2DArray(i);
                    ProfSurfImpl.this.setPntList2DArray(i, o);
                    return old;
                }
                
                public void add(int i, java.util.List o)
                    { ProfSurfImpl.this.insertPntList2D(i, o); }
                
                public java.util.List remove(int i)
                {
                    java.util.List old = ProfSurfImpl.this.getPntList2DArray(i);
                    ProfSurfImpl.this.removePntList2D(i);
                    return old;
                }
                
                public int size()
                    { return ProfSurfImpl.this.sizeOfPntList2DArray(); }
        ...
        public java.util.List<org.landxml.schema.landXML11.PntList2DDocument.PntList2D> xgetPntList2DList()
        {
            final class PntList2DList extends java.util.AbstractList<org.landxml.schema.landXML11.PntList2DDocument.PntList2D>
            {
                public org.landxml.schema.landXML11.PntList2DDocument.PntList2D get(int i)
                    { return ProfSurfImpl.this.xgetPntList2DArray(i); }
                ...
                {
                    org.landxml.schema.landXML11.PntList2DDocument.PntList2D old = ProfSurfImpl.this.xgetPntList2DArray(i);
                    ProfSurfImpl.this.xsetPntList2DArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.PntList2DDocument.PntList2D o)
                    { ProfSurfImpl.this.insertNewPntList2D(i).set(o); }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return ProfSurfImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = ProfSurfImpl.this.getFeatureArray(i);
                    ProfSurfImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { ProfSurfImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = ProfSurfImpl.this.getFeatureArray(i);
                    ProfSurfImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return ProfSurfImpl.this.sizeOfFeatureArray(); }
