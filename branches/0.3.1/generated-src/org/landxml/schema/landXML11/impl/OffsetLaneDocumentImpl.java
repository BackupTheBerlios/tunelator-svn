 ...
 */
public class OffsetLaneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.OffsetLaneDocument
{
    
    public OffsetLaneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName OFFSETLANE$0 = 
     ...
     */
    public org.landxml.schema.landXML11.OffsetLaneDocument.OffsetLane getOffsetLane()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.OffsetLaneDocument.OffsetLane target = null;
            target = (org.landxml.schema.landXML11.OffsetLaneDocument.OffsetLane)get_store().find_element_user(OFFSETLANE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOffsetLane(org.landxml.schema.landXML11.OffsetLaneDocument.OffsetLane offsetLane)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.OffsetLaneDocument.OffsetLane)get_store().add_element_user(OFFSETLANE$0);
            }
     ...
     * This is a complex type.
     */
    public static class OffsetLaneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.OffsetLaneDocument.OffsetLane
    {
        
        public OffsetLaneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName FULLOFFSET$10 = 
            new javax.xml.namespace.QName("", "fullOffset");
        private static final javax.xml.namespace.QName WIDTH$12 = 
            new javax.xml.namespace.QName("", "width");
        private static final javax.xml.namespace.QName SIDEOFROAD$14 = 
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return OffsetLaneImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = OffsetLaneImpl.this.getFeatureArray(i);
                    OffsetLaneImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { OffsetLaneImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = OffsetLaneImpl.this.getFeatureArray(i);
                    OffsetLaneImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return OffsetLaneImpl.this.sizeOfFeatureArray(); }
         ...
         */
        public double getFullOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(FULLOFFSET$10);
                if (target == null)
                {
                    return 0.0;
                }
         ...
         */
        public org.landxml.schema.landXML11.OffsetDistance xgetFullOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.landxml.schema.landXML11.OffsetDistance target = null;
                target = (org.landxml.schema.landXML11.OffsetDistance)get_store().find_attribute_user(FULLOFFSET$10);
                return target;
            }
        }
         ...
         */
        public boolean isSetFullOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                return get_store().find_attribute_user(FULLOFFSET$10) != null;
            }
        }
         ...
         */
        public void setFullOffset(double fullOffset)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(FULLOFFSET$10);
                }
                target.setDoubleValue(fullOffset);
            }
        }
         ...
         */
        public void xsetFullOffset(org.landxml.schema.landXML11.OffsetDistance fullOffset)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.OffsetDistance)get_store().add_attribute_user(FULLOFFSET$10);
                }
                target.set(fullOffset);
            }
        }
         ...
         */
        public void unsetFullOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_attribute(FULLOFFSET$10);
            }
        }
        ...
        public org.apache.xmlbeans.XmlDouble xgetWidth()
        {
            synchronized (monitor())
            {
                ...
                target = (org.apache.xmlbeans.XmlDouble)get_store().find_attribute_user(WIDTH$12);
                return target;
            }
        }
        ...
        public void xsetWidth(org.apache.xmlbeans.XmlDouble width)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlDouble)get_store().add_attribute_user(WIDTH$12);
                }
                target.set(width);
            }
        }
        ...
        public org.landxml.schema.landXML11.SideofRoadType.Enum getSideofRoad()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SIDEOFROAD$14);
                if (target == null)
                {
                    return null;
                }
        ...
        public org.landxml.schema.landXML11.SideofRoadType xgetSideofRoad()
        {
            synchronized (monitor())
            {
                ...
                target = (org.landxml.schema.landXML11.SideofRoadType)get_store().find_attribute_user(SIDEOFROAD$14);
                return target;
            }
        }
        ...
        public boolean isSetSideofRoad()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(SIDEOFROAD$14) != null;
            }
        }
        ...
        public void setSideofRoad(org.landxml.schema.landXML11.SideofRoadType.Enum sideofRoad)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SIDEOFROAD$14);
                }
        ...
        public void xsetSideofRoad(org.landxml.schema.landXML11.SideofRoadType sideofRoad)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.SideofRoadType)get_store().add_attribute_user(SIDEOFROAD$14);
                }
        ...
        public void unsetSideofRoad()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(SIDEOFROAD$14);
            }
        }
    }
}
