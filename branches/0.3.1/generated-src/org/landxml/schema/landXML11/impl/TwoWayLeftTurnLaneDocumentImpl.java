 ...
 */
public class TwoWayLeftTurnLaneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument
{
    
    public TwoWayLeftTurnLaneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName TWOWAYLEFTTURNLANE$0 = 
     ...
     */
    public org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument.TwoWayLeftTurnLane getTwoWayLeftTurnLane()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument.TwoWayLeftTurnLane target = null;
            target = (org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument.TwoWayLeftTurnLane)get_store().find_element_user(TWOWAYLEFTTURNLANE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTwoWayLeftTurnLane(org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument.TwoWayLeftTurnLane twoWayLeftTurnLane)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument.TwoWayLeftTurnLane)get_store().add_element_user(TWOWAYLEFTTURNLANE$0);
            }
     ...
     * This is a complex type.
     */
    public static class TwoWayLeftTurnLaneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.TwoWayLeftTurnLaneDocument.TwoWayLeftTurnLane
    {
        
        public TwoWayLeftTurnLaneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName STARTOFFSET$10 = 
            new javax.xml.namespace.QName("", "startOffset");
        private static final javax.xml.namespace.QName ENDOFFSET$12 = 
        ...
        private static final javax.xml.namespace.QName SIDEOFROAD$16 = 
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return TwoWayLeftTurnLaneImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = TwoWayLeftTurnLaneImpl.this.getFeatureArray(i);
                    TwoWayLeftTurnLaneImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { TwoWayLeftTurnLaneImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = TwoWayLeftTurnLaneImpl.this.getFeatureArray(i);
                    TwoWayLeftTurnLaneImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return TwoWayLeftTurnLaneImpl.this.sizeOfFeatureArray(); }
        ...
        public double getStartOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STARTOFFSET$10);
                if (target == null)
                {
                    return 0.0;
                }
        ...
        public org.landxml.schema.landXML11.OffsetDistance xgetStartOffset()
        {
            synchronized (monitor())
            {
                ...
                target = (org.landxml.schema.landXML11.OffsetDistance)get_store().find_attribute_user(STARTOFFSET$10);
                return target;
            }
        }
        ...
        public boolean isSetStartOffset()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(STARTOFFSET$10) != null;
            }
        }
        ...
        public void setStartOffset(double startOffset)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STARTOFFSET$10);
                }
        ...
        public void xsetStartOffset(org.landxml.schema.landXML11.OffsetDistance startOffset)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.OffsetDistance)get_store().add_attribute_user(STARTOFFSET$10);
                }
        ...
        public void unsetStartOffset()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(STARTOFFSET$10);
            }
        }
        ...
        public double getEndOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ENDOFFSET$12);
                if (target == null)
                {
                    return 0.0;
                }
        ...
        public org.landxml.schema.landXML11.OffsetDistance xgetEndOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.landxml.schema.landXML11.OffsetDistance target = null;
                target = (org.landxml.schema.landXML11.OffsetDistance)get_store().find_attribute_user(ENDOFFSET$12);
                return target;
            }
        }
        ...
        public boolean isSetEndOffset()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(ENDOFFSET$12) != null;
            }
        }
        ...
        public void setEndOffset(double endOffset)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ENDOFFSET$12);
                }
        ...
        public void xsetEndOffset(org.landxml.schema.landXML11.OffsetDistance endOffset)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.OffsetDistance)get_store().add_attribute_user(ENDOFFSET$12);
                }
        ...
        public void unsetEndOffset()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(ENDOFFSET$12);
            }
        }
        ...
        public org.landxml.schema.landXML11.SideofRoadType.Enum getSideofRoad()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SIDEOFROAD$16);
                if (target == null)
                {
                    return null;
                }
        ...
        public org.landxml.schema.landXML11.SideofRoadType xgetSideofRoad()
        {
            synchronized (monitor())
            {
                ...
                target = (org.landxml.schema.landXML11.SideofRoadType)get_store().find_attribute_user(SIDEOFROAD$16);
                return target;
            }
        }
        ...
        public boolean isSetSideofRoad()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(SIDEOFROAD$16) != null;
            }
        }
        ...
        public void setSideofRoad(org.landxml.schema.landXML11.SideofRoadType.Enum sideofRoad)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SIDEOFROAD$16);
                }
        ...
        public void xsetSideofRoad(org.landxml.schema.landXML11.SideofRoadType sideofRoad)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.SideofRoadType)get_store().add_attribute_user(SIDEOFROAD$16);
                }
        ...
        public void unsetSideofRoad()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(SIDEOFROAD$16);
            }
        }
    }
}
