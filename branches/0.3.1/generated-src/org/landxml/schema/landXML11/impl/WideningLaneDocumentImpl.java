 ...
 */
public class WideningLaneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.WideningLaneDocument
{
    
    public WideningLaneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName WIDENINGLANE$0 = 
     ...
     */
    public org.landxml.schema.landXML11.WideningLaneDocument.WideningLane getWideningLane()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.WideningLaneDocument.WideningLane target = null;
            target = (org.landxml.schema.landXML11.WideningLaneDocument.WideningLane)get_store().find_element_user(WIDENINGLANE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setWideningLane(org.landxml.schema.landXML11.WideningLaneDocument.WideningLane wideningLane)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.WideningLaneDocument.WideningLane)get_store().add_element_user(WIDENINGLANE$0);
            }
     ...
     * This is a complex type.
     */
    public static class WideningLaneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.WideningLaneDocument.WideningLane
    {
        
        public WideningLaneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        private static final javax.xml.namespace.QName OFFSET$10 = 
            new javax.xml.namespace.QName("", "offset");
        private static final javax.xml.namespace.QName WIDENING$12 = 
            new javax.xml.namespace.QName("", "widening");
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return WideningLaneImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = WideningLaneImpl.this.getFeatureArray(i);
                    WideningLaneImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { WideningLaneImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = WideningLaneImpl.this.getFeatureArray(i);
                    WideningLaneImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return WideningLaneImpl.this.sizeOfFeatureArray(); }
        ...
        public double getOffset()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(OFFSET$10);
                if (target == null)
                {
                    return 0.0;
                }
        ...
        public org.landxml.schema.landXML11.OffsetDistance xgetOffset()
        {
            synchronized (monitor())
            {
                ...
                target = (org.landxml.schema.landXML11.OffsetDistance)get_store().find_attribute_user(OFFSET$10);
                return target;
            }
        }
        ...
        public boolean isSetOffset()
        {
            ...
            {
                check_orphaned();
                return get_store().find_attribute_user(OFFSET$10) != null;
            }
        }
        ...
        public void setOffset(double offset)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(OFFSET$10);
                }
        ...
        public void xsetOffset(org.landxml.schema.landXML11.OffsetDistance offset)
        {
            synchronized (monitor())
            {
                ...
                if (target == null)
                {
                    target = (org.landxml.schema.landXML11.OffsetDistance)get_store().add_attribute_user(OFFSET$10);
                }
                target.set(offset);
            }
        }
        ...
        public void unsetOffset()
        {
            ...
            {
                check_orphaned();
                get_store().remove_attribute(OFFSET$10);
            }
        }
         ...
         */
        public double getWidening()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.SimpleValue target = null;
                target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(WIDENING$12);
                if (target == null)
                {
                    return 0.0;
                }
         ...
         */
        public org.apache.xmlbeans.XmlDouble xgetWidening()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlDouble target = null;
                target = (org.apache.xmlbeans.XmlDouble)get_store().find_attribute_user(WIDENING$12);
                return target;
            }
        }
         ...
         */
        public boolean isSetWidening()
        {
            synchronized (monitor())
            {
                check_orphaned();
                return get_store().find_attribute_user(WIDENING$12) != null;
            }
        }
         ...
         */
        public void setWidening(double widening)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(WIDENING$12);
                }
                target.setDoubleValue(widening);
            }
        }
         ...
         */
        public void xsetWidening(org.apache.xmlbeans.XmlDouble widening)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlDouble)get_store().add_attribute_user(WIDENING$12);
                }
                target.set(widening);
            }
        }
         ...
         */
        public void unsetWidening()
        {
            synchronized (monitor())
            {
                check_orphaned();
                get_store().remove_attribute(WIDENING$12);
            }
        }
