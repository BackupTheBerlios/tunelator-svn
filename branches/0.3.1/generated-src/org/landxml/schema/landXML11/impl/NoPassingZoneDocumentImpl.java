 ...
 */
public class NoPassingZoneDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.NoPassingZoneDocument
{
    
    public NoPassingZoneDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName NOPASSINGZONE$0 = 
     ...
     */
    public org.landxml.schema.landXML11.NoPassingZoneDocument.NoPassingZone getNoPassingZone()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.NoPassingZoneDocument.NoPassingZone target = null;
            target = (org.landxml.schema.landXML11.NoPassingZoneDocument.NoPassingZone)get_store().find_element_user(NOPASSINGZONE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNoPassingZone(org.landxml.schema.landXML11.NoPassingZoneDocument.NoPassingZone noPassingZone)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.NoPassingZoneDocument.NoPassingZone)get_store().add_element_user(NOPASSINGZONE$0);
            }
     ...
     * This is a complex type.
     */
    public static class NoPassingZoneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.NoPassingZoneDocument.NoPassingZone
    {
        
        public NoPassingZoneImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return NoPassingZoneImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = NoPassingZoneImpl.this.getFeatureArray(i);
                    NoPassingZoneImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { NoPassingZoneImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = NoPassingZoneImpl.this.getFeatureArray(i);
                    NoPassingZoneImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return NoPassingZoneImpl.this.sizeOfFeatureArray(); }
