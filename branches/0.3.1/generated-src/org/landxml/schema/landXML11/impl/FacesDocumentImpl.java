 ...
 */
public class FacesDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.FacesDocument
{
    
    public FacesDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName FACES$0 = 
     ...
     */
    public org.landxml.schema.landXML11.FacesDocument.Faces getFaces()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.landxml.schema.landXML11.FacesDocument.Faces target = null;
            target = (org.landxml.schema.landXML11.FacesDocument.Faces)get_store().find_element_user(FACES$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setFaces(org.landxml.schema.landXML11.FacesDocument.Faces faces)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.landxml.schema.landXML11.FacesDocument.Faces)get_store().add_element_user(FACES$0);
            }
            target.set(faces);
        }
    }
     ...
     * This is a complex type.
     */
    public static class FacesImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.landxml.schema.landXML11.FacesDocument.Faces
    {
        
        public FacesImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
         ...
         */
        public java.util.List<org.landxml.schema.landXML11.FDocument.F> getFList()
        {
            final class FList extends java.util.AbstractList<org.landxml.schema.landXML11.FDocument.F>
            {
                public org.landxml.schema.landXML11.FDocument.F get(int i)
                    { return FacesImpl.this.getFArray(i); }
                
                public org.landxml.schema.landXML11.FDocument.F set(int i, org.landxml.schema.landXML11.FDocument.F o)
                {
                    org.landxml.schema.landXML11.FDocument.F old = FacesImpl.this.getFArray(i);
                    FacesImpl.this.setFArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FDocument.F o)
                    { FacesImpl.this.insertNewF(i).set(o); }
                
                public org.landxml.schema.landXML11.FDocument.F remove(int i)
                {
                    org.landxml.schema.landXML11.FDocument.F old = FacesImpl.this.getFArray(i);
                    FacesImpl.this.removeF(i);
                    return old;
                }
                
                public int size()
                    { return FacesImpl.this.sizeOfFArray(); }
         ...
         */
        public org.landxml.schema.landXML11.FDocument.F[] getFArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                org.landxml.schema.landXML11.FDocument.F[] result = new org.landxml.schema.landXML11.FDocument.F[targetList.size()];
         ...
         * Gets ith "F" element
         */
        public org.landxml.schema.landXML11.FDocument.F getFArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.landxml.schema.landXML11.FDocument.F target = null;
                target = (org.landxml.schema.landXML11.FDocument.F)get_store().find_element_user(F$0, i);
                if (target == null)
                {
         ...
         */
        public void setFArray(org.landxml.schema.landXML11.FDocument.F[] fArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         * Sets ith "F" element
         */
        public void setFArray(int i, org.landxml.schema.landXML11.FDocument.F f)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public org.landxml.schema.landXML11.FDocument.F insertNewF(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.landxml.schema.landXML11.FDocument.F target = null;
                target = (org.landxml.schema.landXML11.FDocument.F)get_store().insert_element_user(F$0, i);
                return target;
            }
        }
        ...
        public java.util.List<org.landxml.schema.landXML11.FeatureDocument.Feature> getFeatureList()
        {
            final class FeatureList extends java.util.AbstractList<org.landxml.schema.landXML11.FeatureDocument.Feature>
            {
                public org.landxml.schema.landXML11.FeatureDocument.Feature get(int i)
                    { return FacesImpl.this.getFeatureArray(i); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature set(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = FacesImpl.this.getFeatureArray(i);
                    FacesImpl.this.setFeatureArray(i, o);
                    return old;
                }
                
                public void add(int i, org.landxml.schema.landXML11.FeatureDocument.Feature o)
                    { FacesImpl.this.insertNewFeature(i).set(o); }
                
                public org.landxml.schema.landXML11.FeatureDocument.Feature remove(int i)
                {
                    org.landxml.schema.landXML11.FeatureDocument.Feature old = FacesImpl.this.getFeatureArray(i);
                    FacesImpl.this.removeFeature(i);
                    return old;
                }
                
                public int size()
                    { return FacesImpl.this.sizeOfFeatureArray(); }
