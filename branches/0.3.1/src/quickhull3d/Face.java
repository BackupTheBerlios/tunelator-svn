	...
	public void computeNormal (Vector3d normal, double minArea)
	 {
	   ...
	   if (area < minArea)
	    { 
	      ...
	      double lenSqrMax = 0;
	      HalfEdge hedge = he0;
          // Get the longest half-edge of the face and its squared length
	      do
		 ...
		 hedge = hedge.next;
	      ...
	      Point3d p1 = hedgeMax.tail().pnt; // Danger. tail() could return null
	      double lenMax = Math.sqrt(lenSqrMax); // Length of te longers half-edge
