...
/**
 * FileFilter for DXF12 files in 2D that's used in the export command file dialog.
 * 
 * @author <a href="mailto:jaferrando@users.berlios.de">Juan Alvarez Ferrando</a>
 */
public class DXF12_2DFileFilter extends FileFilter {
    /**
     * All files are accepted so it allways returns <code>true</code>
